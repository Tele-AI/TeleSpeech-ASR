...
@dataclass
class SpecPretrainingConfig(FairseqDataclass):
    ...
    precompute_mask_config: Optional[SpecMaskingConfig] = None
...
class SpecPretrainingTask(FairseqTask):
    """ """

    cfg: SpecPretrainingConfig

    @classmethod
    def setup_task(cls, cfg: SpecPretrainingConfig, **kwargs):
        """Setup the task (e.g., load dictionaries).

        Args:
            cfg (SpecPretrainingConfig): configuration of this task
        """
