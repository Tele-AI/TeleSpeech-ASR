...
from examples.data2vec.models.modalities.base import D2vModalityConfig, ModalitySpecificEncoder, get_alibi_bias
...
class AudioEncoder(ModalitySpecificEncoder):
    ...
    def __init__(
        ...
        local_encoder = ConvFeatureExtractionModel(
            input_feature_ndim=modality_cfg.input_feature_ndim,
