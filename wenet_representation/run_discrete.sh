...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    for ((i = 0; i < $num_gpus; ++i)); do
    {
        ...
        python wenet/bin/train.py --gpu $gpu_id \
            ...
            --symbol_table $dict \
            --bpe_model $bpemodel \
            --train_data $data_path/$train_set/data.list.discrete \
            --cv_data $data_path/$valid_set/data.list.discrete \
...
if [ ${stage} -le 6 ] && [ ${stop_stage} -ge 6 ]; then
    ...
    for test in ${recog_set}; do
    {
        ...
        for mode in ${decode_modes}; do
        {
            ...
            --data_type $data_type \
            --bpe_model ${bpemodel} \
            --test_data $data_path/$test/data.list.discrete \
            ...
            if [ "${token_type}" = bpe ]; then
                ...
                $data_path/$test/text $test_dir/text > $test_dir/wer
             elif [ "${token_type}" = char ]; then
